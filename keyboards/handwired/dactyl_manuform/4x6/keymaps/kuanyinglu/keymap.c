...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BASE] = LAYOUT(
        ...
        KC_MINS, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,                  KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,KC_BSLS,         
                         KC_LBRC, KC_RBRC,  SFT_TAB, KC_SPC,                KC_LEFT, KC_BSPC, KC_LPRN, KC_RPRN,
                         KC_LCTL, KC_LOPT,  LOWER,   RAISE,                 PLUS,    KC_RSFT, KC_LCMD, KC_ENT 
    ),
    ...
    [_RAISE] = LAYOUT(
        ...
        _______, _______, _______, KC_BTN1, KC_BTN2, KC_BTN3,             KC_WH_D, KC_MS_D, KC_MS_U, KC_MS_R, KC_WH_L, KC_WH_R,
                          _______, _______, _______, _______,             _______, _______, _______, _______,
